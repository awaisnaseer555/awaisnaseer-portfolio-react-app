...
<!-- ## View live preview [here](https://awaisnaseer.netlify.app/). -->
...
export const personalData = {
  ...
  resume:
    "https://drive.google.com/file/d/1FEGW2L0xO0u3cOdjvrtqgS4cYZIgeb_x/view?usp=drive_link",
};
```
