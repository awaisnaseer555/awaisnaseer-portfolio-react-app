    ...
    <section className="relative flex flex-col items-center justify-between py-4 lg:py-12">
      ...
      <div className="grid grid-cols-1 items-start lg:grid-cols-2 lg:gap-12 gap-y-8">
        <div className="order-2 lg:order-1 flex flex-col items-start justify-center p-2 pb-20 md:pb-10 lg:pt-10">
          <h2 className="text-2xl font-bold leading-10 text-white md:font-extrabold lg:text-[2.2rem] lg:leading-[3.5rem]">
            Hello, <br /> 
            {` I'm `}
            <span className=" text-pink-500">{personalData.name}</span>
            {`, leveraging my expertise as a `}
          ...
          <div className="my-12 flex items-center gap-5">
            ...
            { personalData.facebook?.length !== 0 && (
              <Link
          ...
          <div className="overflow-hidden border-t-[2px] border-indigo-900 px-4 lg:px-8 py-4 lg:py-8">
            <code className="font-mono text-xs md:text-sm lg:text-base">
              ...
              <div>
                ...
                <span className="text-gray-400">{`'`}</span>
                <span className="text-amber-300">Mohammad Awais Naseer</span>
                <span className="text-gray-400">{`',`}</span>
              </div>
              <div>
              ...
              <div className="ml-4 lg:ml-8 mr-2">
                ...
                <span className="text-gray-400">{"', '"}</span>
                <span className="text-amber-300">Redux & Context API</span>
                <span className="text-gray-400">{"', '"}</span>
              ...
              <div className="ml-4 lg:ml-8 mr-2">
                ...
                <div>
                  <span className="ml-4 lg:ml-8 mr-2 text-white">cleanCodeAdvocate:</span>
                  <span className="text-orange-400">true</span>
                  <span className="text-gray-400">,</span>
                </div>
                <span className="text-gray-400">{`},`}</span>
